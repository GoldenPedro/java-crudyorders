...
public class CustomersController
{
     ...
     * @see CustomersService#findAllCustomers() CustomersService.findAllCustomers().
     */
     ...
     * <br> Example: <a href="http://localhost:2019/customers/customer/5">PUT http://localhost:2019/customers/customer/5</a>
     *
     * @param updateCustomer A complete customer including all orders to be used to replace
     *                       the customer.
    ...
    /**
     * Updates the customer record associated with the given id with the provided data. Only the provided fields are affected.
     * Orders are added to the customer record. Deleting, modifying orders are different endpoints.
     * <br> Example: <a href="http://localhost:2019/customers/customer/5">PATCH http://localhost:2019/customers/customer/5</a>
     *
     * @param updateCustomer An object containing values for just the fields that are being updated. All other fields are left NULL.
     ...
     * <br> Example: <a href="http://localhost:2019/customers/customer/5">DELETE http://localhost:2019/customers/customer/5</a>
     *
