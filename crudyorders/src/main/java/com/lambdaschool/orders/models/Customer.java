...
public class Customer
{
    ...
    /**
     * Used to determine if the field paymentamt has been set or is NULL, meaning 0 for an integer value.
     * Does not get saved to the database.
     */
    @Transient
    ...
    /**
     * Used to determine if the field outstandingamt has been set or is NULL, meaning 0 for an integer value.
     * Does not get saved to the database.
     */
    @Transient
